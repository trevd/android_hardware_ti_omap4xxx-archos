...
#define PRODUCT_DEVICE_ARCHOS_80     "archosa80sboard"
    ...
    struct omap_stream_out *out)
{
    ...
    if (out) {
        ...
        set_fmtx_on = 0 ; //out->device & AUDIO_DEVICE_OUT_FM_RADIO_TX;
...
static void select_input_device(struct omap_audio_device *adev)
{
    ...
    int fm_rx_on = 0 ; //adev->devices.in_devices & AUDIO_DEVICE_IN_FM_RADIO_RX;
